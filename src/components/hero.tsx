  ...
  return (
    <header className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row items-center justify-center gap-8">
        <div className="w-48 h-48 md:w-64 md:h-64 relative rounded-full overflow-hidden shadow-xl border-4 border-primary-500 transition-transform duration-500 hover:scale-105">
          <Image
        ...
        <div className="text-center md:text-left max-w-2xl">
          <h1 className="text-4xl sm:text-5xl text-gray-200 md:text-6xl font-bold animate-fade-in">
            Hello there! I am Hillori...
          </h1>
          <h2
            className="text-2xl mt-4 text-gray-300 animate-slide-up"
            style={{ animationDelay: "0.2s" }}
          >
            I am a Senior Software Engineer & Technical Lead at Floworks.AI
          </h2>
          <p
